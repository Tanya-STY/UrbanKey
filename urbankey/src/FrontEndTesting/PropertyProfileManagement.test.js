...
describe('PropertyProfileManagement Component', () => {
  ...
  test('allows selecting a file for upload', () => {
    ...
    fireEvent.change(fileInput, { target: { files: [new File(['photo1'], 'photo1.png', { type: 'image/png' })] } });
  ...
  test('displays photo upload section correctly', () => {
    ...
    expect(screen.getByText('You can add 30 photos to your ad')).toBeInTheDocument();
  });
