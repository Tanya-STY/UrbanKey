  ...
  return (
    <div className="outer-container">
      <div className="container">
        <div className="left-div">Left Div Content</div>
        ...
        <div className="right-div">
          ...
          <div className="underline-wrapper">
            <div
              className="membership-buttons-underline"
              style={{
                backgroundColor:
                  activeButton === "Individual" ? "blue" : "white",
              }}
            ></div>
            <div
              className="membership-buttons-underline"
              style={{
                backgroundColor:
                  activeButton === "Corporate" ? "blue" : "white",
              }}
            ></div>
          </div>
              ...
              <div className="form-group">
                <label>
                  ...
                  <span onClick={() => setAllowContact(!allowContact)}>
                    I allow UrbanKey to contact me via e-mail, SMS, etc for
